...
def get_embeddings_matrix(vocab, initial_embedding_np):
    if cfg.embeddings_path == './data/fasttext/wiki.de.bin':
        return get_fasttext_matrix(vocab, initial_embedding_np)
    elif cfg.embeddings_path == './data/glove/glove.6B.50d.txt':
        return get_glove_matrix(vocab, initial_embedding_np)
